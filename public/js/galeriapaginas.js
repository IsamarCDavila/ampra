...
new Vue({
  ...
  methods : {
        getGaleria: function(){
          let vm = this;
          vm.$http.get(ruta_principal+'/admin/getpaginasgaleria/'+pagina.id+'?page='+this.pagination.current_page).then((response) => {
      ...
      showmodal: function(item){
        this.galeria_update = item;
        this.dialogedit = true;
      },
      showConfirmation: function(item){
        this.galeria_delete = item;
      ...
      createItem: function(item){
        ...
        formData.append('pagina_id', this.pagina.id);
        $.ajax({
            url: ruta_principal+'/admin/paginasgaleria/store',
           type: "POST",
           processData: false,
				   contentType: false,
           data : formData,
      ...
      editItem: function(item){
        ...
        let vm = this;
         ...
         formData.append('pagina_id', this.pagina.id);
         $.ajax({
             url: ruta_principal+'/admin/paginasgaleria/update/'+item.id,
            type: "POST",
            processData: false,
            contentType: false,
            data : formData,
      ...
      deleteItem: function(item){
        ...
        $.ajax({
            url: ruta_principal+'/admin/paginasgaleria/delete/'+item.id,
           type: "POST",
           data : formData,
                    success: function (result) {
                        if(result.success==true){
