                     ...
                     <v-flex xs12 sm12>
                        <v-card class="spaceLR">
                           <v-card-title primary-title>
                              <div>
                                 <h3 class="headline mb-0">Editar Galeria</h3>
                              </div>
                           </v-card-title>
                           <v-container grid-list-lg>
                              <v-form method="POST" id="formeditGaleria" :action="url_update +'/'+galeria.id" @submit.prevent="validateBeforeSubmit" accept-charset="UTF-8" novalidate="novalidate" enctype="multipart/form-data">
                                 ...
                                 <v-layout column wrap>
                                   <v-layout row wrap>
                                    ...
                                    <v-layout row wrap>
                                      <v-flex xs10>
                                        <v-text-field
                                           label="Título" :value="galeria.titulo" name="titulo"
                                           ></v-text-field>
                                      </v-flex>
                                      <v-flex xs10>
                                        <v-text-field
                                           label="Link" :value="galeria.link_button" name="link_button"
                                           ></v-text-field>
                                      </v-flex>
                                    </v-layout>
                                    <v-layout row wrap>
                                      <v-flex xs5>
                                        <v-flex xs10 class="sinpaddingleft text-xs-center text-sm-center text-md-center text-lg-center">
                                           ...
                                           <input
                                              ...
                                              >
                                           <div>
                                             <img class="sizeImage hiddenImage" :src="url + '/' + galeria.imagen_path" v-if="galeria.imagen_path"/>
