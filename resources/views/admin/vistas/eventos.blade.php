...
<script src="<?php echo URL::asset('js/eventos.js'); ?>"></script>
@endsection
<!-- /.heading-->
@section('content')
<div id="table-eventos">
   <v-app id="inspire">
      <v-content>
            ...
            <v-layout justify-center align-center>
               <v-flex text-xs-center>
                     ...
                     <v-flex xs12 sm12>
                        <v-card class="spaceLR cardSize">
                           <v-card-title primary-title>
                              <div>
                                 <h3 class="headline mb-0">Eventos</h3>
                              </div>
                              <div class="btn-right">
                                 <v-btn class="btn-xs indigo btnText" v-bind:href="url_new">Nuevo Evento</v-btn>
                              </div>
                           </v-card-title>
                           <br>
                           <v-spacer>  </v-spacer>
                  ...
                  <v-dialog v-model="dialogconfirmation" max-width="500px">
                     <v-card>
                        <v-card-title class="title-modal title-modal">
                           Eliminar item
                        </v-card-title>
                        <v-card-text>
